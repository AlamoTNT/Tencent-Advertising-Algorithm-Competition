...
data_feature = pd.read_csv('../model_/corpus/texts_industry.csv', index_col=[0])
...
for i in range(stack.shape[1]):
    df_stack['industry_tfidf_lr_classfiy_{}'.format(i)] = np.around(stack[:, i], 6) #6是decimals参数, 指保留6位小数
df_stack.to_csv(path+'feature/industry_tfidf_lr_error_single_classfiy.csv', index=None, encoding='utf8')
print('lr特征已保存\n')
...
df_stack = pd.DataFrame()
for i in range(stack.shape[1]):
    df_stack['industry_tfidf_sgd_classfiy_{}'.format(i)] = np.around(stack[:, i], 6)
df_stack.to_csv(path+'feature/industry_tfidf_sgd_error_single_classfiy.csv', index=None, encoding='utf8')
print('sgd特征已保存\n')
...
df_stack = pd.DataFrame()
for i in range(stack.shape[1]):
    df_stack['industry_tfidf_pac_classfiy_{}'.format(i)] = np.around(stack[:, i], 6)
df_stack.to_csv(path+'feature/industry_tfidf_pac_error_single_classfiy.csv', index=None, encoding='utf8')
print('pac特征已保存\n')
...
df_stack = pd.DataFrame()
for i in range(stack.shape[1]):
    df_stack['industry_tfidf_ridge_classfiy_{}'.format(i)] = np.around(stack[:, i], 6)
df_stack.to_csv(path+'feature/industry_tfidf_ridge_error_single_classfiy.csv', index=None, encoding='utf8')
print('ridge特征已保存\n')
...
df_stack = pd.DataFrame()
for i in range(stack.shape[1]):
    df_stack['industry_tfidf_bnb_classfiy_{}'.format(i)] = np.around(stack[:, i], 6)
df_stack.to_csv(path+'feature/industry_tfidf_bnb_error_single_classfiy.csv', index=None, encoding='utf8')
...
df_stack = pd.DataFrame()
for i in range(stack.shape[1]):
    df_stack['industry_tfidf_mnb_classfiy_{}'.format(i)] = np.around(stack[:, i], 6)
df_stack.to_csv(path+'feature/industry_tfidf_mnb_error_single_classfiy.csv', index=None, encoding='utf8')
...
df_stack = pd.DataFrame()
for i in range(stack.shape[1]):
    df_stack['industry_tfidf_lsvc_classfiy_{}'.format(i)] = np.around(stack[:, i], 6)
df_stack.to_csv(path+'feature/industry_tfidf_lsvc_error_single_classfiy.csv', index=None, encoding='utf8')
print('LSVC特征已保存\n')
